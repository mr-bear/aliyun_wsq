...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1413100194, '4', './data/template/4_4_member_login.tpl.php', './template/helin_qyer', 'member/login')
