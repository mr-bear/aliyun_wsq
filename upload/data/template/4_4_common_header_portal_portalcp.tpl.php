...
0
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/header_common.htm', 1413100683, '4', './data/template/4_4_common_header_portal_portalcp.tpl.php', './template/helin_qyer', 'common/header_portal_portalcp')
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/pubsearchform.htm', 1413100683, '4', './data/template/4_4_common_header_portal_portalcp.tpl.php', './template/helin_qyer', 'common/header_portal_portalcp')
;?>
