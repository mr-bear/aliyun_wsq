...
0
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/header_common.htm', 1413100517, '4', './data/template/4_4_common_header_portal_index.tpl.php', './template/helin_qyer', 'common/header_portal_index')
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/pubsearchform.htm', 1413100517, '4', './data/template/4_4_common_header_portal_index.tpl.php', './template/helin_qyer', 'common/header_portal_index')
;?>
