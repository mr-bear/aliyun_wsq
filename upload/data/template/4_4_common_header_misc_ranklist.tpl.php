...
0
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/header_common.htm', 1413087554, '4', './data/template/4_4_common_header_misc_ranklist.tpl.php', './template/helin_qyer', 'common/header_misc_ranklist')
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/pubsearchform.htm', 1413087554, '4', './data/template/4_4_common_header_misc_ranklist.tpl.php', './template/helin_qyer', 'common/header_misc_ranklist')
;?>
