...
0
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/helin_qyer/forum/forumdisplay_list.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
|| checktplrefresh('./template/helin_qyer/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1413100417, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/helin_qyer', 'forum/forumdisplay')
...
<?php if(empty($_G['forum']['sortmode'])) { ?><div id="threadlist" class="tl bm bmw" style="position: relative;">
