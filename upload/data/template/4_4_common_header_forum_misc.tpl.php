...
0
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/header_common.htm', 1413087481, '4', './data/template/4_4_common_header_forum_misc.tpl.php', './template/helin_qyer', 'common/header_forum_misc')
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/pubsearchform.htm', 1413087481, '4', './data/template/4_4_common_header_forum_misc.tpl.php', './template/helin_qyer', 'common/header_forum_misc')
;?>
