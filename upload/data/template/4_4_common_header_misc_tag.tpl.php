...
0
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/header_common.htm', 1413100465, '4', './data/template/4_4_common_header_misc_tag.tpl.php', './template/helin_qyer', 'common/header_misc_tag')
|| checktplrefresh('./template/helin_qyer/common/header.htm', './template/helin_qyer/common/pubsearchform.htm', 1413100465, '4', './data/template/4_4_common_header_misc_tag.tpl.php', './template/helin_qyer', 'common/header_misc_tag')
;?>
