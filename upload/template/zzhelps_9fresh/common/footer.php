	...
	<div id="ft" class="wp cl">
		<div id="flk" class="y">
		  <p>
			...
			<div class="xs0">模板支持：<a href="http://www.zzhelps.com" target="_blank">站长帮</a></div>
		</div>
		<div id="frt">
			<p>Powered by <strong>Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--><span class="xs0"></span></p>
