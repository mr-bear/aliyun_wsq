...
<!--{subtemplate common/header_common}-->
	...
	<meta name="msapplication-task" content="name=$_G['setting']['navs'][2]['navname'];action-uri={echo !empty($_G['setting']['domain']['app']['forum']) ? 'http://'.$_G['setting']['domain']['app']['forum'] : $_G[siteurl].''};icon-uri={$_G[siteurl]}{IMGDIR}/bbs.ico" />
...
<body id="nv_{$_G[basescript]}" class="pg_{CURMODULE}{if $_G['basescript'] === 'portal' && CURMODULE === 'list' && !empty($cat)} {$cat['bodycss']}{/if}" onkeydown="if(event.keyCode==27) return false;">
	...
	<!--{if empty($topic) || $topic['useheader']}-->
			...
			<div class="wp cl">
				<div class="nbg">
					...
					<div id="um">
						...
						<p>
							<strong class="vwmy{if $_G['setting']['connect']['allow'] && $_G[member][conisbind]} qq{/if}"><a href="home.php?mod=space&uid=$_G[uid]" target="_blank" title="{lang visit_my_space}"  id="archycaidan" onMouseOver="showMenu({'ctrlid':'archycaidan','pos':'34!','ctrlclass':'a','duration':2});" class="showmenu">{$_G[member][username]}</a></strong>
		...
		<!--{if !IS_ROBOT}-->
            ...
            <div id="archycaidan_menu" class="p_pop {if !$_G['uid']}blk{/if}" style="display: none;">
					<ul>
                                ...
                                <li><a href="home.php?mod=spacecp&ac=plugin&id=qqconnect:qqshow">QQ秀绑定</a></li>
 			<li><a href="home.php?mod=spacecp&ac=profile&op=verify">实名认证</a></li>
