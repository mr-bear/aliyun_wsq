...
<div class="topnew cl">
	<div class="topnew_l">
        ...
        <!--[diy=topnew_flash]--><div id="topnew_flash" class="area"></div><!--[/diy]-->
        </div>
        <div class="topnew_thread1">
         <!--[diy=topnewthread1]--><div id="topnewthread1" class="area"></div><!--[/diy]-->
        </div>
    </div>
    <div class="topnew_m">
    <!--[diy=diytopnew_m]--><div id="diytopnew_m" class="area"></div><!--[/diy]-->
    </div>
    <div class="topnew_r">
    	<div class="topnew_yindao">
        	<!--[diy=diytopnew_yindao]--><div id="diytopnew_yindao" class="area"></div><!--[/diy]-->
         </div>
        <div class="topnew_thread2">
        	<!--[diy=diytopnew_thread2]--><div id="diytopnew_thread2" class="area"></div><!--[/diy]-->
         </div>
        <div class="topnew_thread3">
        	<!--[diy=diytopnew_thread3]--><div id="diytopnew_thread3" class="area"></div><!--[/diy]-->
            </div>
    </div>
</div>
    <!--//结束-->
...
<div id="pt" class="bm cl">
	...
	<!--{/if}-->
	<div class="z">
		<a href="./" class="nvhm" title="{lang homepage}">$_G[setting][bbname]</a><em>&raquo;</em><a href="">{$_G[setting][navs][2][navname]}</a>$navigation
	</div>
	...
	<div class="mn">
		...
		<div class="fl bm">
			...
			<div class="bm bmw {if $forumcolumns} flg{/if} cl">
				...
				<div id="category_-1" class="bm_c" style="border-right: 1px solid #F3F3F3;border-left: 1px solid #F3F3F3; {echo $collapse['category_-1']}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{loop $collectiondata['follows'] $key $colletion}-->
							...
							<td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
								<div class="fl_icn_g">
								<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank"><img src="{STYLEIMGDIR}/forum{if $followcollections[$key]['lastvisit'] < $colletion['lastupdate']}_new{/if}.gif" alt="$colletion[name]" /></a>
								</div>
								<dl>
							...
							<!--{if $forumcolumns>1}-->
								...
								<td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
									...
									<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
										<dt><a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>$forum[name]</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="tieshu" class="xw0 xi1" title="{lang forum_todayposts}"> ($forum[todayposts])</em><!--{/if}--></dt>
					...
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{if $cat['forumcolumns']}-->
							...
							<td class="fl_g" width="$cat[forumcolwidth]">
								...
								<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
									<dt><a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>$forum[name]</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1 jintie" title="{lang forum_todayposts}">+$forum[todayposts]</em><!--{/if}--></dt>
									<!--{if empty($forum[redirect])}--><dd><em>{lang forum_threads}: <!--{echo dnumber($forum[threads])}--></em>, <em>{lang forum_posts}: <!--{echo dnumber($forum[posts])}--></em></dd><!--{/if}-->
									<dd>
									<!--{if $forum['permission'] == 1}-->
										{lang private_forum}
				...
				<div id="category_-2" class="bm_c" style="{echo $collapse['category_-2']}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{loop $collectiondata['data'] $key $colletion}-->
							...
							<td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
								<div class="fl_icn_g">
								<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank"><img src="{STYLEIMGDIR}/forum.gif" alt="$colletion[name]" /></a>
								</div>
								<dl>
									<dt><a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}">$colletion[name]</a></dt>
									<dd><em>{lang forum_threads}: <!--{echo dnumber($colletion[threadnum])}--></em>, <em>{lang collection_commentnum}: <!--{echo dnumber($colletion[commentnum])}--></em></dd>
