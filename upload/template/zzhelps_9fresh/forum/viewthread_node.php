...
<tr>
	...
	<tr><td class="plc plm">
		...
		<!--{elseif $post['signature'] && !$post['anonymous'] && $showsignatures}-->
			<div class="sign" style="max-height:{$_G['setting']['maxsigrows']}px;maxHeightIE:{$_G['setting']['maxsigrows']}px;">
				<span class="sw-sign"><a href="home.php?mod=spacecp&ac=profile&op=info" rel="nofollow" target="_blank">设置签名</a></span>
				$post[signature]
			</div>
